...
@Component
public class CmpInstructionResolver implements InstructionResolver {

    @Getter
    private final String name;
    private final RegisterSet registerSet;

    public CmpInstructionResolver(RegisterSet registerSet) {
        this.name = "CMP";
    ...
    public int resolve(String instruction) {
        ...
        return (0x5 & 0xF) << 28 | (0) << 8 | (registerIdx & 0xF) << 4 | (sourceIdx & 0xF);
    }
}
